...
export default {
  title: 'Components/ItemHandbook',
  component: ItemHandbook
} as Meta;

type Story = StoryObj<typeof ItemHandbook>;
...
export const Handbook: Story = {
  args: {
    items: [
      ...
      {
        imagePath: handbook7,
        title: 'Top 6 reputable skin rejuvenation addresses in Hanoi'
      },
      {
        imagePath: handbook8,
        title: 'Top 7 good places to treat melasma in Hanoi'
      },
      {
        imagePath: handbook9,
        title: 'Top 7 reputable skin rejuvenation addresses in Ho Chi Minh City'
      }
    ]
  }
};
